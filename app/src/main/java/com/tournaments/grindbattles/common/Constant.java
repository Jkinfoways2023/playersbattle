...
public class Constant {
    ...
    public static final String LIST_HTML_GAME_URL = Config.ADMIN_PANEL_URL + "html_game/?";
    public static final String LIST_HTML_GAME_RESULT = Config.ADMIN_PANEL_URL + "game_result/?";
    ...
    //My Contest
    public static final String ONGOING_MATCH_WITHOUT_FILTER_URL = Config.ADMIN_PANEL_URL + "get_all_match_ongoing/?";
    public static final String UPCOMING_MATCH_WITHOUT_FILTER_URL = Config.ADMIN_PANEL_URL + "get_all_match_upcoming/?";
    public static final String COMPLETED_MATCH_WITHOUT_FILTER_URL = Config.ADMIN_PANEL_URL + "get_all_match_result/?";

    // New Game
    public static final String JOIN_GAME = Config.ADMIN_PANEL_URL + "join_game/?";
    public static final String GET_GAME_DATA = Config.ADMIN_PANEL_URL + "get_game_data/?";
    public static final String SHOW_GAME_FULL_RESULT = Config.ADMIN_PANEL_URL + "show_game_fullresult/?";
    ...
    //public static final String CREATE_ORDER_PAYTM_PAY = "https://upipg.gtelararia.com/order/create";
